...
public class Mirror_Turn : MonoBehaviour
{
    ...
    private void Particle_Start()
    {
        ...
        this.SunnyParticle = GameObject.Instantiate(this.SunnyParticle, pos, Quaternion.Euler(0, 180, 0)) as GameObject;
        this.SunnyParticle.transform.parent = transform;

        this.SunnyHardParticle = GameObject.Instantiate(this.SunnyHardParticle, pos, Quaternion.Euler(0, 180, 0)) as GameObject;
